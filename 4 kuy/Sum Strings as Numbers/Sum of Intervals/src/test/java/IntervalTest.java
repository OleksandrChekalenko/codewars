...
import static org.example.Interval.sumIntervals2;
import static org.example.Interval.sumIntervals3;
...
class IntervalTest {
    ...
    void shouldHandleEmptyIntervals() {
        ...
        assertEquals(0, sumIntervals2(new int[][]{}));
        assertEquals(0, sumIntervals2(new int[][]{{4, 4}, {6, 6}, {8, 8}}));
        assertEquals(0, sumIntervals3(new int[][]{}));
        assertEquals(0, sumIntervals3(new int[][]{{4, 4}, {6, 6}, {8, 8}}));
    }
    ...
    void shouldAddDisjoinedIntervals() {
        ...
        assertEquals(9,  sumIntervals2(new int[][]{{1, 2}, {6, 10}, {11, 15}}));
        assertEquals(11, sumIntervals2(new int[][]{{4, 8}, {9, 10}, {15, 21}}));
        assertEquals(7,  sumIntervals2(new int[][]{{-1, 4}, {-5, -3}}));
        assertEquals(78, sumIntervals2(new int[][]{{-245, -218}, {-194, -179}, {-155, -119}}));

        assertEquals(9,  sumIntervals3(new int[][]{{1, 2}, {6, 10}, {11, 15}}));
        assertEquals(11, sumIntervals3(new int[][]{{4, 8}, {9, 10}, {15, 21}}));
        assertEquals(7,  sumIntervals3(new int[][]{{-1, 4}, {-5, -3}}));
        assertEquals(78, sumIntervals3(new int[][]{{-245, -218}, {-194, -179}, {-155, -119}}));
    }
    ...
    void shouldAddOverlappingIntervals() {
        ...
        assertEquals(7, sumIntervals2(new int[][]{{1, 4}, {7, 10}, {3, 5}}));
        assertEquals(6, sumIntervals2(new int[][]{{5, 8}, {3, 6}, {1, 2}}));
        assertEquals(19, sumIntervals2(new int[][]{{1, 5}, {10, 20}, {1, 6}, {16, 19}, {5, 11}}));

        assertEquals(7, sumIntervals3(new int[][]{{1, 4}, {7, 10}, {3, 5}}));
        assertEquals(6, sumIntervals3(new int[][]{{5, 8}, {3, 6}, {1, 2}}));
        assertEquals(19, sumIntervals3(new int[][]{{1, 5}, {10, 20}, {1, 6}, {16, 19}, {5, 11}}));
    }
